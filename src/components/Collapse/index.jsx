...
function Collapse({ valeur, description, page }) {
	...
	return (
		<div className={'containerCollapse' + classe}>
			<p
				className={'titreCollapse' + classe}
				onClick={() => affichageDescription()}
			>
				{valeur}
				{isOpened ? (
				...
				<Fragment>
					{isOpened ? (
						<span className='containerDescriptionCollapse'>
							<p
								className={'descriptionCollapse' + classe + ' collapseOuvert'}
								onClick={() => affichageDescription()}
							>
								{description}
							</p>
						...
						<span className='containerDescriptionCollapse'>
							<p className={'descriptionCollapse' + classe + ' collapseFerme'}>
								{description}
							</p>
						</span>
					)}
